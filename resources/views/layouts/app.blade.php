                    ...
                    <ul class="navbar-nav ml-auto nav-flex-icons">
                        ...
                        @guest
                            ...
                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="register nav-link" href="{{ route('register') }}">{{ __('Register') }}</a>
                                </li>
                            @endif
                        @else
                            <li class="nav-item avatar">
                                <img src="storage/app/public/avatars/{{ Auth::user()->avatar }}" class="rounded-circle z-depth-0" alt="avatar" height="35">
                            </li>
